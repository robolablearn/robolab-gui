...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve Robolab',
        description: 'Robolab telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The Robolab Team is always looking to better understand how Robolab is used around the ' +
            'world. To help support this effort, you can allow Robolab to automatically send usage information to ' +
            'the Robolab Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the Robolab privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the Robolab Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the Robolab Team',
        description: 'Text for telemetry modal opt-in button',
                    ...
                    <p><FormattedMessage
                        ...
                        values={{
                            privacyPolicyLink: (<a
                                ...
                                href="https://www.robolablearn.com/privacy-policy"
